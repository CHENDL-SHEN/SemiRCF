...
a_path = 'predictions_metal'  # work dir
# (gan_train_metal&bsds)EdgeModel_gen.pth
# (mmd_train_metal&bsds)EdgeModel_gen.pth
# (unsup_gan_train_metal&bsds)EdgeModel_gen.pth
# (unsup_mmd_train_metal&bsds)EdgeModel_gen.pth
a_load_model_dir = 'final_model/(unsup_mmd_train_metal&bsds)EdgeModel_gen.pth'  # file to resume
a_data_mode = 'gray' # rgb for NYUD; gray for metal;
...
# dataset dir
a_TARGET_LAB_IMG_FLIST = 'data_metal/image'
a_TARGET_LAB_MASK_FLIST = 'data_metal/mask'
a_TARGET_LAB_EDGE_FLIST = 'data_metal/label'

a_SOURCE_LAB_IMG_FLIST = 'data_bsds/image'
a_SOURCE_LAB_MASK_FLIST  = 'data_bsds/mask'
a_SOURCE_LAB_EDGE_FLIST  = 'data_bsds/label'

a_TARGET_UNLAB_IMG_FLIST = 'data_metal/image_unlab'
a_TARGET_UNLAB_MASK_FLIST = 'data_metal/mask_unlab'
a_TARGET_UNLAB_EDGE_FLIST =  'data_metal/label_unlab'
a_TARGET_UNLAB_EDGE_Pseudo_FLIST =  a_path + '/Pse_label_for_unlab'

a_TEST_IMG_FLIST = 'data_metal/image_test'
