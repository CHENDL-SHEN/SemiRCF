...
def build_pr_curve(dirs, mode = 'ods'):
    ...
    colors_plt = ['blue', 'deepskyblue', 'yellowgreen', 'green', 'red']
    name_map = []
    f_idx = []
    pr_merge = []
    methods = []
...
if __name__ == '__main__':
    ...
    #    dirs = ['Canny_eval', 'gPb-OWT-UCM_eval', 'RCF_eval', 'BDCN_eval', 'Proposed_eval']
    ...
    #dirs = ['Canny_eval', 'gPb-OWT-UCM_eval', 'RCF_eval', 'BDCN_eval', 'Proposed_eval']
    #dirs = ['Canny_mask_eval', 'gPb-OWT-UCM_mask_eval', 'RCF_mask_eval', 'BDCN_mask_eval', 'Proposed_mask_eval']
    #dirs = ['Proposed_eval']
    #dirs = ['semiRCF_eval','(Revised)semiRCF_eval']
